...
CREATE INDEX perfil_geo_index ON perfil USING GIST (ST_SetSRID(ST_MakePoint(latitud, longitud), 4326));
...
CREATE TABLE IF NOT EXISTS preferencias(
	...
	distancia_maxima INT DEFAULT 3000 CHECK (distancia_maxima <= 3000) NOT NULL,
...
CREATE TABLE IF NOT EXISTS tiene_habilidades(
	...
	PRIMARY KEY (id_cuenta, habilidades),
